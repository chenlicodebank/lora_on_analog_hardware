...
# # use analogsgd during training
# import torch
# from aihwkit.optim import AnalogSGD
# torch.optim.SGD = AnalogSGD
...
# #
# def gen_rpu_config_fromcorey(g_max=25, tile_size=256, modifier_std=0.08):
#     rpu_config = InferenceRPUConfig()
#
#     rpu_config.mapping.digital_bias = True
#     rpu_config.mapping.weight_scaling_omega = pcm_adcnoise0.0
#     rpu_config.mapping.weight_scaling_columnwise = True
#     rpu_config.mapping.learn_out_scaling = True
#     rpu_config.mapping.out_scaling_columnwise = True
...
#     rpu_config.remap.type = WeightRemapType.CHANNELWISE_SYMMETRIC
#     # rpu_config.clip.type = WeightClipType.FIXED_VALUE
#     # rpu_config.clip.fixed_value = pcm_adcnoise0.0
#     rpu_config.clip.type = WeightClipType.LAYER_GAUSSIAN
...
#     # rpu_config.forward.inp_res = -pcm_adcnoise0  # 8-bit resolution.
#     # rpu_config.forward.out_res = -pcm_adcnoise0  # 8-bit resolution.
#     rpu_config.forward.inp_res = pcm_adcnoise0 / (2**8 - 2)  # 8-bit resolution.
#     rpu_config.forward.out_res = pcm_adcnoise0 / (2**8 - 2)  # 8-bit resolution.
...
def main():
    ...
    peft_config = LoraConfig(r=8, lora_alpha=32,
                             lora_dropout=0.1,
                             target_modules=["dense","query","key","value","qa_outputs"],)
    ...
    # optimizer = AnalogSGD(model.parameters(), lr=0.0005, momentum=0.9)
    optimizer = AnalogAdam(model.parameters(), lr=0.00005)
